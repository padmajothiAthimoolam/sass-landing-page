...
const NavLink =({ title }) => (  //immediate return function
    ...
    <header className='fixed top-0 left-0 z-50 w-full py-10'>
        <div className='container flex h-14 items-center max-lg:px-5'>
            <a className='flex-1 cursor-pointer z-2'>
                <img src="/images/landify.svg" width={400} height={400} alt="logo"/>
            </a>
            <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0',isOpen ? "max-lg:opacity-100": "max-lg:poin" ) }>
                    ...
                    <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                        <ul className='flex max-lg:block max-lg:px-12'>
                            ...
                            <li className='nav-logo'>
                                <LinkScroll to="hero" offset={-100} spy smooth className={clsx("max-lg:hidden transition-transform duration-500 ursor-pointer")}>
                                <img src="/images/landify.svg" width={160} height={55} alt="logo"/>
                                </LinkScroll>
                            </li>
                            <li className='nav-li'>
                                <NavLink title="faq" />
